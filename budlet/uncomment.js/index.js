...
var jsonFilePath = path.join(__dirname, '..', 'data.json'); // Build the correct file path
...
fs.writeFileSync('../data.uncom.json', res, 'utf8'); // Write the resulting data to a file
